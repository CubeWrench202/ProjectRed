...
class RenderOR extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(8, 9, 6), new RedstoneTorchModel(8, 2.5, 8))

    override val coreModels:Seq[ComponentModel] = wires++torches:+new BaseComponentModel
...
class RenderNOR extends GateRenderer[ComboGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires:+torch:+new BaseComponentModel
...
class RenderAND extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(4, 8, 6), new RedstoneTorchModel(12, 8, 6),
...
class RenderXOR extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(4.5, 8, 6), new RedstoneTorchModel(11.5, 8, 6),
...
class RenderXNOR extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(8, 2, 8), new RedstoneTorchModel(4.5, 8, 6),
...
class RenderBuffer extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(8, 2, 8), new RedstoneTorchModel(8, 9, 6))
...
class RenderMultiplexer extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(8, 2, 8), new RedstoneTorchModel(9, 10.5, 6),
...
class RenderPulse extends GateRenderer[ComboGatePart]
{
    ...
    val torches = Array(new RedstoneTorchModel(4, 9.5, 6), new RedstoneTorchModel(11, 9.5, 6),
...
class RenderRepeater extends GateRenderer[ComboGatePart]
{
    ...
    val varTorches = Array(new RedstoneTorchModel(12.5, 12, 6), new RedstoneTorchModel(12.5, 11, 6),
    ...
    override val coreModels:Seq[ComponentModel] = wires++Seq(endTorch, new BaseComponentModel)

    override def switchModels:Seq[ComponentModel] = Seq(varTorches(shape))
    override def allSwitchModels:Seq[ComponentModel] = varTorches
...
class RenderRandomizer extends GateRenderer[ComboGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++chips:+new BaseComponentModel
...
class RenderSRLatch extends GateRenderer[SequentialGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = Seq(new BaseComponentModel)

    override def switchModels:Seq[ComponentModel] = if (shape == 0) wires1++torches1 else wires2++torches2
    override def allSwitchModels:Seq[ComponentModel] = wires1++wires2++torches1++torches2
...
class RenderToggleLatch extends GateRenderer[SequentialGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++torches++Seq(lever, new BaseComponentModel)
...
class RenderLightSensor extends GateRenderer[ComboGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++Seq(solar, new BaseComponentModel)
...
class RenderRainSensor extends GateRenderer[ComboGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++Seq(sensor, new BaseComponentModel)
...
class RenderSequencer extends GateRenderer[SequentialGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = torches:+new BaseComponentModel
...
class RenderStateCell extends GateRenderer[SequentialGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++torches++Seq(chip, new BaseComponentModel)
...
class RenderSynchronizer extends GateRenderer[SequentialGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++chips++Seq(torch, new BaseComponentModel)
...
class RenderBusXcvr extends GateRenderer[BundledGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++panels++Seq(cable, new BaseComponentModel)
...
class RenderComparator extends GateRenderer[SequentialGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++Seq(torch, new BaseComponentModel)
...
class RenderBusRandomizer extends GateRenderer[BundledGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = Seq(cable, panel, new BaseComponentModel)

    override def switchModels:Seq[ComponentModel] = if (shape == 0) wires1 else wires2
    override def allSwitchModels:Seq[ComponentModel] = wires1++wires2
...
class RenderBusConverter extends GateRenderer[BundledGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++Seq(cable, bar, new BaseComponentModel)
...
class RenderBusInputPanel extends GateRenderer[BundledGatePart]
{
    ...
    override val coreModels:Seq[ComponentModel] = wires++Seq(buttons, cable, new BaseComponentModel)

    override def prepareInv()
    {
        wires(0).on = false
        buttons.pressMask = 13
