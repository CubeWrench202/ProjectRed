...
object GateDefinition extends ItemDefinition
{
    ...
    val NullCell = new GateDef(null)//"pr_agate")
    val InvertCell = new GateDef(null)//"pr_agate")
    val BufferCell = new GateDef(null)//"pr_agate")
    val Comparator = new GateDef("pr_tgate")
    val ANDCell = new GateDef(null)//"pr_rgate")
